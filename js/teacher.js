...
if(GetObj('ISL_Contt').scrollLeft <= 0){GetObj('ISL_Contt').scrollLeft = GetObj

('ISL_Contt').scrollLeft + GetObj('List3').offsetWidth}
...
if(GetObj('ISL_Contt').scrollLeft >= GetObj('List3').scrollWidth){GetObj('ISL_Contt').scrollLeft =

GetObj('ISL_Contt').scrollLeft - GetObj('List3').scrollWidth;}
GetObj('ISL_Contt').scrollLeft += Space ;
}
function CompScr(){
var num;
